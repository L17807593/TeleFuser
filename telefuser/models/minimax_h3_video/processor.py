...
def get_normalize_transform(norm_type: str = "imagenet", *, inplace: bool = False) -> Normalize:
    ...
    def __init__(
        ...
        *,
        ...
        self._runtime_owned_transform = (
            get_normalize_transform(pixel_norm_type, inplace=True) if transform is None else None
        )
