...
# Qwen2.5-VL compatibility is retained because the shared flow-matching base
# defines the legacy V1 policy alongside the V2 policy.
...
def qwen25_preprcess_grid_thw(self, grid_thw: torch.Tensor):
...
def qwen25_forward_without_grid_thw(
    self,
    hidden_states: torch.Tensor,
...
def apply_lingbot_qwen25_vl_patch():
    ...
    hf_qwen25vl.Qwen2_5_VisionTransformerPretrainedModel.forward = qwen25_forward_without_grid_thw
    hf_qwen25vl.Qwen2_5_VisionTransformerPretrainedModel.preprcess_grid_thw = qwen25_preprcess_grid_thw
