# ruff: noqa: E741
"""Triton grouped-MoE kernels for LingBot-VLA v2.

Internal implementation; callers should use ``telefuser.ops.lingbot_vla_v2_moe``.
"""
...
def robby_moe_forward(
    ...
    _moe_gate_up_grouped_kernel[(E, triton.cdiv(max_routes, 16), triton.cdiv(I, 32))](
        hidden_states,
        gate_weight,
        up_weight,
        counts,
